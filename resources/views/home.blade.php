...
<div class="py-4" style="min-height: 90vh;">
    ...
    <div class="row g-4 justify-content-center mb-5" style="max-width: 900px; margin: 0 auto;">
        <div class="col-12 col-md-6">
            <a href="/books" class="quick-link d-block p-4 rounded-4 text-center fw-semibold shadow-sm h-100 text-dark"
        ...
        <div class="col-12 col-md-6">
            <a href="/books/create" class="quick-link d-block p-4 rounded-4 text-center fw-semibold shadow-sm h-100 text-dark"
        ...
        <div class="col-12 col-md-6">
            <a href="/genres" class="quick-link d-block p-4 rounded-4 text-center fw-semibold shadow-sm h-100 text-dark"
        ...
        <div class="col-12 col-md-6">
            <a href="{{ route('recommendations') }}" class="quick-link d-block p-4 rounded-4 text-center fw-semibold shadow-sm h-100 text-dark"
        ...
        <div class="col-12 col-md-6 mx-auto">
            <a href="/faq" class="quick-link d-block p-4 rounded-4 text-center fw-semibold shadow-sm h-100 text-dark"
